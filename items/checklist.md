...
- [x] The UID, name and roles of all group members.
...
- [x] A UML diagram of your application 
- [x] A description of the application design
...
Please note that each member must complete their individual submissions for the following items on Wattle.
